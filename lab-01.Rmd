...
NA stands for not available. It is so because some of the values under variable n_2021 have NA as their value.
...
Mean is affected by outliers and they do not influence median
...
visitors_with_nations %>%
  count(nation)
```
Because there are outliers again.
